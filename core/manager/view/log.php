...
<p align="right"><b><a onclick="if(!confirm('此操作会只保留最新的100条{$opname},而将其他更早的记录删除.确定吗?')) return false;" href="admin.php?file=log&action=del{$action}">删除多余{$opname}</a></b></p>
    ...
    <tr>
      <td valign="top" style="width:150px;"><div class="tableborder">
        ...
        <div class="leftmenubody">
          <div class="leftmenuitem">&#8226; <a href="admin.php?file=log&action=adminlog">操作记录</a></div>
          <div class="leftmenuitem">&#8226; <a href="admin.php?file=log&action=loginlog">登陆记录</a></div>
          <div class="leftmenuitem">&#8226; <a href="admin.php?file=log&action=dberrorlog">数据库出错记录</a></div>
        </div>
      </div></td>
      <td valign="top" style="width:20px;"></td>
      <td valign="top">
	  <form action="admin.php?file=log" method="POST" name="form"><table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
...
foreach($logdb as $key => $log){print <<<EOT
        ...
        <tr class="tablecell">
          ...
          <td nowrap="nowrap"><a href="?file=$log[5]">$log[5]</a></td>
